...
contract LandOwnership is ERC721URIStorage, Ownable {
 ...
 constructor(address initialOwner) ERC721("LandVOwnershipNFT", "LRN") Ownable(initialOwner) {
        landCounter = 0;
    }
...
//        A URI (Uniform Resource Identifier) pointing to metadata about the land. This metadata often includes information such as images, descriptions, or other relevant details.
    ...
    function makeInstallmentPayment(uint256 _landId) external payable {
        ...
        installment.nextPaymentDue = block.timestamp + installment.installmentInterval; // Update next payment due date based on the agreed interval
